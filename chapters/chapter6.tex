...
From now on, we will refer to the two definitions of chordality, \Cref{def:chordal1}, and \Cref{def:chordal2}, respectively with Chordal$_1$ and Chordal$_2$. Intuitively, these two definitions are equivalent. However, for our purpose, we only need one side of the implication.
