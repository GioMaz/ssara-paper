...
To show an example of a translated program, we take the program defined in \Cref{fig:example-jair} and compile it. The result is shown in \Cref{fig:example-nasm}.
...
L2.2:
	...
	jmp	L2
\end{lstlisting}
\caption{Assembly translation of the program in \Cref{fig:example-jair}}
