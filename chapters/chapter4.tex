...
Where \texttt{ig\_insert\_instinfos} is a function that, given an interference graph and a list of live sets, returns a graph where a clique is added for each live set of the list.
