...
In this chapter, we put together the different components of our \gls{ra} pipeline. In \Cref{sec:pipeline}, we define the \texttt{regassign} function that does exactly that. In \Cref{sec:codegen}, we discuss the code generation. Finally, in \Cref{sec:examples}, we present some examples of translated \gls{jair} programs.
