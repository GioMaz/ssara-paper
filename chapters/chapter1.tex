...
\begin{itemize}
\item In \Cref{sec:ir}, we define an intermediate language that adheres closely to SSA principles while remaining suitable for register allocation;
\item In \Cref{sec:interpreter}, we reason about the semantics for this intermediate language by defining a virtual machine that can execute programs written in it;
