...
Now that we covere the \gls{jair} implementation, we demonstrate its capabilities in \Cref{fig:example-jair} with an example of the Fibonacci function along with the same example in a \gls{ssa} form representation.
...
% $B_2 :=$ Block (Normal 2) $[$ \\
% $r(3) \leftarrow \phi [$(0, Normal 1); (4, Normal 2)$]$ \\
% $r(4) \leftarrow \phi [$(1, Normal 1); (6, Normal 2)$]$ \\
% $r(5) \leftarrow \phi [$(2, Normal 1); (7, Normal 2)$]$ \\
% $]$ $[$ \\
% $r(6) \leftarrow r(4) + r(3);$ \\
% $r(7) \leftarrow r(5) - i(1);$ \\
% $]$ (if $r(7) = i(1)$ then $B_3$ else $B_2$) \\

% $B_3 :=$ Block (Normal 3) $[]$ $[]$ (ret $r(6)$) \\
