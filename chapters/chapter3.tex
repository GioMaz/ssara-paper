...
We also include the \texttt{UNASSIGNED} register, which is used as a default value for the coloring. We explain the purpose of this register in \Cref{sec:ra}.
