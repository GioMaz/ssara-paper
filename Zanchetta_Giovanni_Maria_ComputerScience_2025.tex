...
% Coq language definition for lstlistings
\lstdefinelanguage{Coq}{
  morekeywords={Definition, Inductive, Class, Instance, Fixpoint, Function, forall, exists, match, with, end, if, then, else, let, fix, in, Some, None, fun, Type, Prop, Set},
  sensitive=true,
  morecomment=[l]{(*},
  morecomment=[s]{(*}{*)},
  morestring=[b]",
