...
\definecolor{langblue}{RGB}{0,0,180}
\definecolor{langgreen}{RGB}{0,120,0}
\definecolor{langred}{RGB}{180,0,0}
\definecolor{langpurple}{RGB}{120,0,120}
...
\lstdefinestyle{Coq}{
    language=Coq,
    keywordstyle=[1]\color{langblue},
    keywordstyle=[2]\color{langpurple},
    keywordstyle=[3]\color{langred},
    tabsize=2,
