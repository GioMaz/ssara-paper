...
% \definecolor{cbcyan}{RGB}{240,228,66}
...
\lstdefinelanguage{Rocq}{
    morekeywords=[1]{Definition, Inductive, CoInductive, Class, Instance, Fixpoint, CoFixpoint, Function, Proof, Qed, Module, Fail, Require, Import},
